...
public class GetPostService {
    ...
    public Page<PostOutput> getPostsOfFriends(String accessToken, Pageable pageable) {
        ...
        Page<PostEntity> postEntitiesOfFriends =
                postRepository.findAllByUserIdInAndGroupIdEquals(friendIds, null, pageable);
    ...
    public Page<PostOutput> getPostsByUserId(Long searchUserId, String accessToken, Pageable pageable){
        ...
        Page<PostEntity> postEntityPage = postRepository.findAllByUserIdAndStateInAndGroupIdEquals(searchUserId, states, null, pageable);
